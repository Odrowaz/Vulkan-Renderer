...
## Note
This is a fork of the instructor's base repository (`aiv01/2526_PROG3_Vulkan`). The original provided only a minimal cube-rendering example with normals displayed on screen; the work above was added on top of that foundation.
